...
function init() {
	...
	//elgg_register_css('jquery.jqgrid', '/mod/hypeDBExplorer/vendors/jqgrid/css/ui.jqgrid.css');
	elgg_register_css('db_explorer.jquery-ui', '/mod/hypeDBExplorer/vendors/jquery-ui/jquery-ui.min.css');
