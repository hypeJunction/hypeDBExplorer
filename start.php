...
function init() {
	$actions_path = __DIR__ . "/actions/db_explorer/";
	...
	elgg_register_css('db_explorer.jquery-ui', elgg_get_simplecache_url('framework/db_explorer/jquery-ui.css'));
	elgg_register_css('db_explorer.stylesheet', elgg_get_simplecache_url('framework/db_explorer/stylesheet.css'));
