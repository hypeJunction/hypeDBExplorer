...
$row_count = array_map(static fn($r) => (object) $r, elgg()->db->getConnection('read')->executeQuery("SELECT COUNT(*) AS count FROM {$dbprefix}annotations WHERE owner_guid = $guid")->fetchAllAssociative());
