...
$row_count = \hypeJunction\DBExplorer\query("SELECT COUNT(*) AS count FROM {$dbprefix}entities WHERE container_guid = $guid");
...
$row_data = \hypeJunction\DBExplorer\query("SELECT * FROM {$dbprefix}entities e
