...
$row_count = \hypeJunction\DBExplorer\query("SELECT COUNT(*) AS count FROM {$dbprefix}metadata WHERE entity_guid = $guid");
...
$row_data = \hypeJunction\DBExplorer\query("SELECT md.id, md.entity_guid, md.name, md.value, md.value_type, md.time_created
